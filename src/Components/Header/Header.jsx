      ...
      <div className='fixed z-50 flex justify-between items-center w-full bg-slate-100 py-5 px-10'>
        ...
        <div>
            <ul className='flex'>
                ...
                <li className='mr-5'>
                <a href='#sobre' className='text-slate-500 hover:text-black'>sobre</a>
                </li>
                <li className='mr-5'>
                <a href='#finalidade' className='text-slate-500 hover:text-black'>finalidade</a>
                </li>
                <li className='mr-5'>
                <a href='#envolvidos' className='text-slate-500 hover:text-black'>envolvidos</a>
                </li>
                <li className='mr-5'>
